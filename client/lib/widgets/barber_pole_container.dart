...
class BarberPoleContainer extends StatefulWidget {
  // barber pole
  final int duration; // directly affects speed (lower is faster)
...
class _BarberPoleContainerState extends State<BarberPoleContainer>
    ...
    return RepaintBoundary(
      child: MouseRegion(
        ...
        child: ValueListenableBuilder(
          ...
          builder: (context, hovering, _) => Container(
            width: widget.width,
